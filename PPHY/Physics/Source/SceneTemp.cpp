...
bool SceneTemp::CheckCollision(GameObject *go1, GameObject *go2)
{
...
float SceneTemp::CheckCollision2(GameObject * go1, GameObject * go2)
{
...
void SceneTemp::CollisionResponse(GameObject * go, GameObject * go2)
{
	if (go2->type == GameObject::GO_BALL)
	{
		Vector3 u1 = go->vel;
...
void SceneTemp::LoadObjects(vector<string> data)
{
	string temp;
	GameObject *go;
...
void SceneTemp::RenderGO(GameObject *go)
{
	switch (go->type)
	{
...
=======
	case GameObject::GO_PLAYER:
		...
		modelStack.PopMatrix();
		break;
>>>>>>> 6e3c657d8378d1313d1cdab5bfddda19e4077af0
